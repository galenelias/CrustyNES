...
void ::SaltyNES::DirectXPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::SaltyNES::DirectXPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 3:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::AppBarButton^>(element3))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::SaltyNES::DirectXPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::SaltyNES::DirectXPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
