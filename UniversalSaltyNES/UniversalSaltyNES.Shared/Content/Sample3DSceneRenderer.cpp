...
void Sample3DSceneRenderer::Render()
{
	...
	DX::ThrowIfFailed(m_deviceResources->GetD3DDeviceContext()->Map(m_cubeTextureTexture.Get(), 0 /*SubResource*/, D3D11_MAP_WRITE_DISCARD, 0, &mappedResource));
	...
	m_deviceResources->GetD3DDeviceContext()->Unmap(m_cubeTextureTexture.Get(), 0 /*SubResource*/);
...
void Sample3DSceneRenderer::CreateDeviceDependentResources()
{
	...
	auto loadTextureTask = createCubeTask.then([this]() {
		...
		//DX::ThrowIfFailed(CreateWICTextureFromFile(m_deviceResources->GetD3DDevice(), m_deviceResources->GetD3DDeviceContext(), L"Assets/turtle.jpg", &pTexture, m_cubeTextureResource.GetAddressOf(), 0 /*maxSize*/));
