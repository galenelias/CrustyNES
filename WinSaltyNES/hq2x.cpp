...
#pragma endregion Inline Common.h


#pragma region Inline init.c
...
#pragma endregion Inline init.c
...
void hq2x_32_rb( const uint32_t * sp, uint32_t srb, uint32_t * dp, uint32_t drb, int Xres, int Yres )
{
    int  i, j, k;
...
void hq2x_32( const uint32_t * sp, uint32_t * dp, int Xres, int Yres )
{
